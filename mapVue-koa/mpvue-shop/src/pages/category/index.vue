<template>
  <div class="category">
    ...
    <div class="content">
      ...
      <scroll-view class="right" srcoll-y="true" >
        <div class="banner">
        ...
        <div class="bottom">
          <div class="item" @click="categoryList(item.id) in detailData.subList" v-for="(item, index) in detailData.subList" :key="index">
